...
if (!file.exists(raw_counts_file)) {
  ...
  GEOquery::getGEOSuppFiles(GEO = curr_gse, baseDir = "data", makeDirectory = TRUE)
  invisible(file.path("data", curr_gse))
...
# Write this for later
write.table(norm_cpm, file="data/normalized_rnaseq.txt", sep="\t")
