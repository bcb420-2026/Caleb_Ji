...
expressed. Some effects may not be seen in large changes but many small changes.
...
Cytoscape is used to further explore the gene set enrichments, to see if 

#### Raw Enrichment Map Representation
![Raw Enrichment Map Representation](figures/original_network.png)
...
![Curated and Annotated Enrichment Map Representation](figures/curated_network.png)
...
![Network themes](figures/network_themes.png)
**Figure 5.** 
